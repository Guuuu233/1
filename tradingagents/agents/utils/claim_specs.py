...
class ClaimSpecErrorCode(str, Enum):
    ...
    ERR_SPEC_UNFALSIFIABLE = "ERR_SPEC_UNFALSIFIABLE"
    ...
    ERR_SPEC_MISSING_METRIC = "ERR_SPEC_MISSING_METRIC"
    ...
    ERR_SPEC_NON_NUMERIC_THRESHOLD = "ERR_SPEC_NON_NUMERIC_THRESHOLD"
    ...
    ERR_SPEC_MISSING_SOURCE = "ERR_SPEC_MISSING_SOURCE"
...
ERR_SPEC_UNFALSIFIABLE: str = ClaimSpecErrorCode.ERR_SPEC_UNFALSIFIABLE.value
...
ERR_SPEC_MISSING_METRIC: str = ClaimSpecErrorCode.ERR_SPEC_MISSING_METRIC.value
...
ERR_SPEC_NON_NUMERIC_THRESHOLD: str = ClaimSpecErrorCode.ERR_SPEC_NON_NUMERIC_THRESHOLD.value
...
ERR_SPEC_MISSING_SOURCE: str = ClaimSpecErrorCode.ERR_SPEC_MISSING_SOURCE.value
...
NON_NUMERIC_THRESHOLD: str = ERR_SPEC_INVALID_THRESHOLD
